...
<div class="bg-white rounded-lg shadow-lg p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <button type="button" 
                class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-colors duration-150"
    ...
    <div class="mb-6">
        <form action="{{ route('products.index') }}" method="GET" class="flex space-x-4">
            ...
            <button type="submit" class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-colors duration-150">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex space-x-2">
                            ...
                            <button type="button" 
                                    class="inline-flex items-center px-3 py-1 bg-yellow-400 hover:bg-yellow-500 text-white rounded-md transition-colors duration-150"
                                    data-bs-toggle="modal" 
...
<div class="modal fade" id="createProductModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content rounded-lg shadow-lg">
            <div class="modal-header bg-gradient-to-r from-red-600 to-red-800 p-4 rounded-t-lg">
                ...
                <form action="{{ route('products.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="category_id" 
                                class="block w-full border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500" 
                                required>
                            @foreach($categories as $category)
                        ...
                        <div>
                            ...
                            <div class="relative rounded-lg shadow-sm">
                                ...
                                <input type="number" name="price" step="0.01" 
                                       class="block w-full pl-12 border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500" 
                                       required>
                            </div>
                        </div>
                    ...
                    <div class="pt-6 border-t border-gray-200">
                        <div class="flex justify-end space-x-3">
                            ...
                            <button type="submit" 
                                    class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-medium transition-colors duration-150">
                                Add Product
                            </button>
                        </div>
                    </div>
