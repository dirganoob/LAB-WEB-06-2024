...
@section('header-button')
    <div class="text-center mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center mt-3" style="gap: 20px;">
            <!-- Filter Form -->
            <form method="GET" action="{{ url('/product') }}" class="d-flex align-items-center" style="gap: 10px;">
            ...
            <a href="{{ url('/product/create') }}" class="btn btn-primary d-flex align-items-center" style="height: 40px;">
                Tambah Data
            </a>
        </div>
    </div>
